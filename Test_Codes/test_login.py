...
#         product = self.driver.find_element(by=By.XPATH, value=login_data.ElementLocators.xpath_product).text
#         assert product == 'Products'
#         print("SUCCESS # LOGGED IN WITH USERNAME {username} and PASSWORD {password}".format(username=login_data.LoginData.username2, password=login_data.LoginData.password))
